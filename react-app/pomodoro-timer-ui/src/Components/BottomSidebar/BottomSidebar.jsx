...
export default function BottomSidebar() {
  ...
  return (
    <SlideX shouldAnimate={sidebarStates.listOpen}>
...
export function SlideX({ children, shouldAnimate }) {

  return <div className={!shouldAnimate? "slide-x":"slide-x animate"}>{children}</div>;
